package com.asraful.audionetwork;
...
//                      //shouldShowRequestPermissionRationale will return true
        ...
        if (audioList != null && audioList.size() > 0) {
            ...
            recyclerView.addOnItemTouchListener(new CustomTouchListener(this, new onItemClickListener() {
                ...
                public void onClick(View view, int index) {
                    //playAudio(index);
                    try {
                        playAudio(audioList.get(index).getData());
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
    ...
    private void loadAudioFromServer() {
        ...
        String url = "http://54.218.116.9/index.php/app/v2/purpose_wise_song_list";

        OkHttpUtils
                .post()
                .url(url)
                .addParams("album_id", "8")
                .build()
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        try {
                            ...
                            if (obj.getInt("status") == 1) {
                                JSONArray jsonArray = obj.getJSONArray("album_id_wise_song_list");
                                audioList = new ArrayList<>();
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    Audio audio = new Audio(
                                            ...
                                            item.getString("album_name"),
                                            item.getString("artist_name")
                                    );

                                    audioList.add(audio);
                                }
                                Log.e("Size", "" + audioList.size());
                                if (audioList.size() > 0) {
                                    initRecyclerView();
                                    progressDialog.dismiss();
                                }
    ...
    private void playAudio(String url) throws Exception {
        ...
        mediaPlayer.setDataSource("http://54.218.116.9/index.php/app/v2/purpose_wise_song_list/" + url);
        mediaPlayer.prepare();
        mediaPlayer.start();
    }
